...
def predict():
    ...
    tree_names=['Aloevera','Amla','Amruta_Balli','Arali','Ashoka','Ashwagandha','Avacado','Bamboo','Basale','Betel','Betel_Nut','Brahmi','Castor','Aloevera','Doddapatre','Ekka','Ganike','Guava','Geranium','Tulsi','Hibiscus','Honge','Insulin','Jasmine',
    ...
    pathh = "static\\images\\uploaded_image\\new_image.jpeg"


    file_name = 'new_image.jpeg'
    folder_path = 'upload-page\\static\\images\\uploaded_image'
